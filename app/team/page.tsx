      ...
      <main className="pt-24 pb-28">
        <div className="container mx-auto px-4">
          ...
          <p className="text-orchi-light/70 mb-12">
            ...
            limiti e da una passione ardente che infiamma ogni nostra azione.
            Ogni membro è uno specialista esperto, maestro nel proprio ruolo
            cruciale, e contribuisce in modo vitale all'equilibrio e
            all'efficacia della nostra strategia complessiva. È questa profonda
            sinergia, unita alla nostra incrollabile coesione e alla fiducia
            reciproca, che ci trasforma in una forza imbattibile sul campo,
            sempre pronti a lottare fianco a fianco per conquistare la vittoria.
          </p>
              ...
              teamMembers.map((member) => (
                ...
                >
                  <Card className="overflow-hidden bg-orchi-gray/10 border-orchi-gray hover:border-orchi-gold transition-all group h-full">
                    ...
                    <div className="absolute top-4 right-4 bg-orchi-red px-3 py-1 z-10">
          ...
          <div className="mt-20 p-8 bg-orchi-gray/20 border border-orchi-gray relative">
            ...
            <div className="relative z-10">
              ...
              <p className="text-center text-orchi-light/70 mb-6 max-w-2xl mx-auto">
                ...
                crescere e competere? Gli Orchi sono sempre alla ricerca di
                nuovi talenti da integrare nel team.
              </p>
