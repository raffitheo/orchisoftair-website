                        ...
                        >
                            <div className="cookies-policy-main-box">
                                <p>
                                    ...
                                    come e perché utilizziamo queste tecnologie
                                    sul nostro sito web. I termini “Orchi”,
                                    “noi”, “ci” e “nostro” includono l'A.S.D.
                                    Gli Orchi Trieste. Utilizzando il nostro
                                    sito web, l'utente acconsente alla
                                    memorizzazione e all'accesso ai cookies e ad
                                    altre tecnologie sul proprio dispositivo, in
                                    conformità con la presente Politica sui
                                    cookies.
                                </p>
                                ...
                                <p>
                                    I cookies sono piccoli file di dati che
                                    vengono scaricati sul dispositivo quando si
                                    visita un sito web. Questi vengono poi
                                    inviati al sito web di origine a ogni visita
                                    successiva o a un altro sito web che li
                                    riconosce. I cookies sono utili perché ci
                                    permettono di riconoscere il dispositivo e
                                ...
                                <ul>
                                    ...
                                    <li>
                                        <span>
                                            <b>Funzionalità:</b> Per ricordare
                                            le preferenze degli utenti e
                                            migliorare la navigazione tra le
                                            pagine.
                                        </span>
                                    </li>
                                </ul>
                                ...
                                <p>
                                    ...
                                    seconda della durata con cui rimangono
                                ...
                                <ul>
                                    <li>
                                        <span>
                                            ...
                                            dispositivo solo durante la visita
                                            al nostro sito.
                                        </span>
                                    </li>
                                    <li>
                                        <span>
                                            ...
                                            dispositivo per un periodo più
                                            lungo, variabile a seconda delle
                                            loro funzioni.
                                        </span>
                                    </li>
                                </ul>
                                ...
                                <p>
                                    Utilizzata per memorizzare le preferenze
                                    degli utenti.
                                </p>
                                ...
                                <p>
                                    La maggior parte dei dispositivi e dei
                                    browser web sono impostati per accettare i
                                    cookies per impostazione predefinita. Se si
                                    preferisce, è possibile rimuovere o
