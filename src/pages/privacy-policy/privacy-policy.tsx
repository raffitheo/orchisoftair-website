            ...
            <div className="privacy-policy-container" ref={ref} {...props}>
                ...
                >
                    <div className="privacy-policy-main-box">
                        ...
                        <p>
                            A.S.D. Gli Orchi Trieste (compreso anche il suo sito web) prende molto seriamente la privacy
                            dei propri utenti. Questa Informativa descrive come raccogliamo, utilizziamo e proteggiamo
                            le informazioni degli utenti che si iscrivono alla nostra newsletter.
                        </p>

                        <h3>1. RACCOLTA DEI DATI</h3>

                        <p>
                            Quando un utente si iscrive alla nostra newsletter, raccogliamo unicamente il suo indirizzo
                            e-mail. Non raccogliamo altre informazioni personali.
                        </p>
                        ...
                        <ul>
                            ...
                            <li>
                                <span>Fornire informazioni su iniziative e attività di A.S.D. Gli Orchi Trieste.</span>
                            </li>
                        </ul>
                        ...
                        <ul>
                            <li>
                                <span>
                                    Annullare l'iscrizione alla newsletter in qualsiasi momento utilizzando il link di
                                    disiscrizione presente in ogni e-mail.
                                </span>
                            </li>
                            <li>
                                <span>
                        ...
                        <p>
                            Adottiamo misure di sicurezza per proteggere gli indirizzi e-mail raccolti da accessi non
                            autorizzati, alterazioni, divulgazioni o distruzioni.
                        </p>

                        <h3>6. UTILIZZO DEI COOKIES</h3>

                        <p>
                            Il nostro sito utilizza cookies per migliorare l'esperienza di navigazione degli utenti. I
                            cookies sono piccoli file di dati che vengono salvati sul tuo dispositivo quando visiti il
                            nostro sito web.
                        </p>
                        ...
                        <p>
                            L'indirizzo e-mail dell'utente potrebbe essere conservato e trattato al di fuori dell'Unione
                            Europea. Adottiamo misure adeguate per proteggere i dati personali in conformità con questa
                            Informativa.
                        </p>
                        ...
                        <p>
                            ...
                            possibile. Se si ritiene che siamo in possesso di dati di o su un bambino di età inferiore
                            ai 14 anni, preghiamo di contattarci.
                        </p>
                        ...
                        <p>
                            Per qualsiasi domanda o richiesta relativa alla privacy dei tuoi dati, siamo conttatabili a:
                        </p>
