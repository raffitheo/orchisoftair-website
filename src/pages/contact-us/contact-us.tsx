...
const ContactUs = forwardRef<HTMLDivElement, ContactUsProps>(({ ...props }, ref) => {
                ...
                <div className="contact-us-container">
                    ...
                    <div className="contact-us-main-container">
                        <div className="contact-us-main-box">
                            <p>
                                Se hai domande da farci, puoi contattarci tramite messaggio privato sui nostri canali
                                social, come <a href="https://www.instagram.com/orchisoftair_official/">Instagram</a> o{' '}
                                <a href="https://www.facebook.com/orchitrieste/">Facebook</a>. Siamo sempre felici di
                                rispondere alle tue domande e fornirti tutte le informazioni di cui hai bisogno.
                                Tuttavia, per facilitare la comunicazione e garantirti una risposta rapida e accurata,
                                ti invitiamo a compilare il modulo seguente. In questo modo, possiamo raccogliere tutte
                                le informazioni necessarie per ricontattarti nel modo più efficiente possibile. Grazie
            ...
            case 'error-no-data':
                return (
                    <p className="contact-us-response-message">
                        Si è presentato un errore imprevisto, ti chiediamo di riporvare più tardi.
                    </p>
                );

            case 'loading':
                return <p className="contact-us-response-message">Caricamento in corso...</p>;

            case 'success':
                return (
                    <p className="contact-us-response-message">
                        Grazie, il messaggio è stato inviato correttamente e verrai ricontattat* al più presto!
                    </p>
                );
        }
    }
