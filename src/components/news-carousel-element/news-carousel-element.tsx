...
export interface NewsCarouselElementProps extends HTMLAttributes<HTMLDivElement> {
    category?: string;
    href?: string;
    isLoading?: boolean;
    src?: string;
...
const NewsCarouselElement = forwardRef<HTMLDivElement, NewsCarouselElementProps>(
