...
export interface WelcomeMessagePopupProps extends HTMLAttributes<HTMLDivElement> {
    content: string;
    onClick: React.MouseEventHandler<HTMLDivElement>;
}

const WelcomeMessagePopup = forwardRef<HTMLDivElement, WelcomeMessagePopupProps>(
