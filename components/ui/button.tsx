...
const buttonVariants = cva(
  'cursor-pointer inline-flex items-center justify-center gap-2 whitespace-nowrap rounded-lg text-sm font-medium tactical-text ring-offset-background transition-all duration-300 focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-ring focus-visible:ring-offset-2 disabled:pointer-events-none disabled:opacity-50 [&_svg]:pointer-events-none [&_svg]:size-4 [&_svg]:shrink-0 tactical-text transform hover:scale-105',
  {
    variants: {
      variant: {
        default:
      ...
      size: {
        ...
        lg: 'h-14 rounded-lg px-10 py-6 text-lg',
        icon: 'h-12 w-12',
      },
    },
    defaultVariants: {
